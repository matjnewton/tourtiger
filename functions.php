...
function tourtiger_scripts_method() {
		...
		wp_register_style('datetimepicker', get_stylesheet_directory_uri() .'/includes/front/css/bootstrap-datetimepicker.css', array(),'20120285', 'all');
		wp_register_style('select2', get_stylesheet_directory_uri() .'/includes/front/css/select2.min.css', array(),'20120285', 'all');
		wp_register_style('transfergestcss', get_stylesheet_directory_uri() .'/includes/front/css/style.css', array(),'20120285', 'all');
