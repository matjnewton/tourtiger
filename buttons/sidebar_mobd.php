...
<div class="btn-group book-btn-wrapper book-btn2">
  ...
  <button
      type="button"
      class="btn-default dropdown-toggle book-btn2-inner"
      data-toggle="dropdown"
      aria-haspopup="true"
      aria-expanded="false"<?php if($cta_button_radius): echo ' style="border-radius:'.$cta_button_radius.'px"'; endif;?>>
    <?php echo $bbt; ?> <span class="caret"></span>
  </button>
  <div class="arrow-right"></div>

  <?php
  if( have_rows('button_sub_options') ) :
    $smobd_counter = 0; ?>

    <ul class="dropdown-menu" data-checker="sidebar_mobd">
      <?php
      while( have_rows('button_sub_options') ):
        the_row();
        ...
        <li>
          ...
          elseif($integrate_peek && ($button_type == 'Use as third party integration Link')):
              ...
              <a href="<?php echo $link; ?>"
                 class="peek-book-button-flat"
                 data-purchase-type="activity"
                 data-button-text=""
                 data-activity-gid="<?php echo $link; ?>"
                 style="border-radius:0; text-align:left;"><?php echo $button_text; ?>
              </a>
          ...
          elseif($integrate_getinsellout && ($button_type === 'Use as third party integration Link')) :
            ...
            <a class="giso_cb giso_btn"<?php if($getinsellout_data_pn): ?>
              data-pn="<?php echo $getinsellout_data_pn; ?>"<?php endif; ?><?php if($getinsellout_data_url): ?>
              data-url="<?php echo $getinsellout_data_url; ?>"<?php endif; ?><?php if($getinsellout_data_evt): ?>
              data-evt="<?php echo $getinsellout_data_evt; ?>"<?php endif; ?>
              href="<?php if($link): echo $link; endif; ?>"><?php echo $button_text; ?>
            </a>
          ...
          elseif($integrate_rezdy && ($button_type === 'Use as third party integration Link')) :
            ...
            <?php
          elseif ($integrate_zaui && ($button_type === 'Use as third party integration Link')) :
            ?>

            <a onclick="return Zaui.open(event)"
               class="button-booking zaui-embed-button override"
               href="<?php echo $link; ?>"><?php echo $button_text; ?>
            </a>

            <?php
          elseif($integrate_orioly && ($button_type === 'Use as third party integration Link')) :
            ?>
            ...
            <?php
          elseif ($integrate_regiondo && ($button_type === 'Use as third party integration Link')) :
            ?>
            ...
            <?php
          elseif ($button_type === 'iframe-popup') :
            ?>
