                        ...
                        <div class="view-btn-wrapper">
                            ...
                            <?php elseif(isset($integrate_fareharbor)&&$integrate_fareharbor && isset($use_as_integration_link)&&$use_as_integration_link): ?>
                                <a href="<?php if(isset($fareharbor_shortname)&&$fareharbor_shortname): ?>https://fareharbor.com/<?php echo $fareharbor_shortname; ?>/items/<?php if(isset($third_party)&&$third_party == 'all-availability'): ?>calendar/<?php endif; ?><?php if(isset($third_party)&&$third_party == 'tour-item'): echo $link??''.'/'; endif; ?><?php if(isset($third_party)&&$third_party == 'tour-item-calendar'): echo $link??''.'/calendar/'; endif; ?><?php else: echo '#'; endif; ?>" onclick="<?php if(isset($fareharbor_shortname)&&$fareharbor_shortname): ?>FH.open({ shortname: '<?php echo $fareharbor_shortname; ?>',<?php if(isset($third_party)&&$third_party == 'all-availability'): ?> view: 'all-availability',<?php endif; ?><?php if(isset($third_party)&&$third_party == 'tour-item' || isset($third_party)&&$third_party == 'tour-item-calendar'): ?> view: { item: <?php echo $link??''; ?> }<?php endif; ?><?php if(isset($third_party)&&!$third_party == 'tour-item-calendar'): ?>, fullItems: 'yes'<?php endif; ?> }); return false;<?php endif; ?>">
                                    <?php echo $button_label??''; ?>
                                </a>
