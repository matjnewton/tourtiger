                    ...
                    <?php elseif($integrate_peek && ($button_type == 'Use as third party integration Link')): ?>
                            <a href="<?php if($book_tours): echo $book_tours; endif; ?>" class="peek-book-button-flat book-btn" data-purchase-type="activity" data-button-text="<?php echo $cta_button_text; ?>" data-activity-gid="<?php if($book_tours): echo $book_tours; endif; ?>"><?php echo $cta_button_text; ?></a>
