...
// }
            ...
            <div class="home_page_search integrate_atlasx">
                <div class="container">
                    <div class="row">
                        <form class="form-horizontal" action="/search/" method="get">
                            '. $block .'
                            <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1 rezdy_box one_date_hide">
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1 rezdy_box num_people-wrap">
                                <div class="add-on">
                                    <!--<span class="num_people-label">Number of People</span> -->
                                    <input type="number" size="1" id="num_people" name="num_people" min="1" max="50" value="1" class="form-control rezdy_date "  required placeholder="Number of People" />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 rezdy_search-submit-wrap">
                                <div class="add-on">
                                    <input id="rezdy_search-submit" type="submit" class="btn btn-success rezdy_search" name="search" value="Search" style="width:100%;">
            ...
            <script type="text/javascript">
                jQuery(function() {
                    ...
                    jQuery("body").addClass("integrate_atlasx_with_this_website");
