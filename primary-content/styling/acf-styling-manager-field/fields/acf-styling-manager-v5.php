...
class acf_field_styling_manager extends acf_field {
	...
	*/
	...
	function render_field( $field ) {
		...
		*/
		...
		render_manage_option_page( $field );
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-styling_manager', "{$url}assets/js/input.js", array('acf-input'), $version );
		wp_enqueue_script('acf-input-styling_manager');
		
		
		// register & include CSS
		wp_register_style( 'acf-input-styling_manager', "{$url}assets/css/input.css", array('acf-input'), $version );
		wp_enqueue_style('acf-input-styling_manager');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-styling_manager'),
		}
