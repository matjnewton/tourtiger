...
<div class="row">
  ...
  <?php endif; ?>
  <nav class="regular-type <?php if( isset($use_logo) && ( $use_logo == true ) && !($logo_covers_both_menus)): echo 'col-sm-10 col-md-9 col-lg-9 use-logo'; else: echo 'col-sm-12 col-md-12 col-lg-12'; endif; ?>">
    <div class="main-nav-wrapper<?php if( isset($all_caps) && $all_caps == true): ?> all-caps<?php endif; ?>">

      <?php if( empty($secondary_menu) || $secondary_menu != true ): ?>
      ...
      <?php
       ...
       if (isset($menu_name) && $menu_name) $args['menu'] = $menu_obj ?? '';

      ?>
      <?php wp_nav_menu( $args ); ?>

      <?php // if (current_user_can('edit_posts')) wp_nav_menu(['menu' => 'Languages', 'fallback_cb' => '__return_empty_string']); @todo - check what is this for and where is being used ?>
