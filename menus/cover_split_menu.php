...
<?php
$items_wrap = '<div class="col-sm-5 col-md-5 col-lg-5 left-menu-part main-nav-wrapper"><div class="hidden-xs hidden-sm"><div class="above-split-bar"><span class="motto">'.$left_secondary_menu.'</span></div></div>';
