...
(function(factory) {
    ...
    var methods = {
        ...
        init: function () {   
            ...
            $flyBookScheldule = $('[data-flybook-target]').not('[data-flybook-inited="1"]');

            if ($flyBookScheldule.length > 0) {
              $flyBookScheldule.each(function(){
                var $wrapper = $(this);
                var targetID = $wrapper.attr('data-flybook-target');

                new FbBookNowButton({entityId:targetID,entityType:'tickets',accountId:243,targetId:'FlybookButton'+targetID+'-243-tickets',domain:'go.theflybook.com',protocol:'https'});
              });
            }
