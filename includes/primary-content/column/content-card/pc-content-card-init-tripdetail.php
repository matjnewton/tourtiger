...
$cc_style__ccc_css = isset($cc_style__ccc_css) && is_array($cc_style__ccc_css) ? $cc_style__ccc_css : ['','',''];
$cc_style__ccc_css[1] = $cc_style__ccc_css[1] ?? '';
$cc_style__ccc_css[2] = $cc_style__ccc_css[2] ?? '';
...
echo $cc_style__ccc_css[1]&&isset($cc_style) ? '#pc_wrap .' . $cc_style . ' .pc--c__tripdetail--headline {' . $cc_style__ccc_css[1] . '}' : '';
...
echo $cc_style__ccc_css[0] ?: '';
echo $cc_style__ccc_css[1]&&isset($cc_style) ? '#pc_wrap .' . $cc_style . ' .pc--c__tripdetail--label {' . $cc_style__ccc_css[1] . '}' : '';
...
echo $cc_style__ccc_css[0] ?: '';
echo $cc_style__ccc_css[1]&&isset($cc_style) ? '#pc_wrap .' . $cc_style . ' .pc--c__tripdetail---details {' . $cc_style__ccc_css[1] . '}' : '';
...
echo $cc_style__ccc_css[0] ?: '';
echo $cc_style__ccc_css[1]&&isset($cc_style) ? '#pc_wrap .' . $cc_style . ' .pc--c__tripdetail---details a {' . $cc_style__ccc_css[1] . '}' : '';
echo $cc_style__ccc_css[2]&&isset($cc_style) ? '#pc_wrap .' . $cc_style . ' .pc--c__tripdetail---details a:hover {' . $cc_style__ccc_css[2] . '}' : '';
