...
if ( have_rows( $bc_style, 'option' ) ) {
	while ( have_rows( $bc_style, 'option' ) ) { the_row();
		...
		echo $bc_style__title_set[1] ? '.pc_wrap .' . $bc_style . ' .pc--blog__post .pc--blog__title {' . $bc_style__title_set[1] . '}' : '';
		...
		echo $bc_style__date_set[1] ? '.pc_wrap .' . $bc_style . ' .pc--blog__post .pc--blog__date {' . $bc_style__date_set[1] . '}' : '';
		...
		echo $bc_style__button_set[1] ? '.pc_wrap .' . $bc_style . ' .pc--blog__post .pc--blog__button {' . $bc_style__button_set[1] . '}' : '';
		echo $bc_style__button_set_hover ? '.pc_wrap .' . $bc_style . ' .pc--blog__post .pc--blog__button:hover {' . $bc_style__button_set_hover . '}' : '';
