...
if ( get_sub_field( 'fc_style__co_pric_font' ) ) {
	...
	$fc_style__fcc_css .=  "font-family: '" . $fc_style__co_pric_font_family . "'; ";
	$fc_style__fcc_css .=  "font-weight: " . $fc_style__co_pric_font_weight . "; ";
	$fc_style__fcc_css .=  "text-align: " . $fc_style__co_pric_font['text_align'] . "; ";
	$fc_style__fcc_css .=  "font-size: " . $fc_style__co_pric_font['font_size'] . "px; ";
	$fc_style__fcc_css .=  "line-height: " . $fc_style__co_pric_font['line_height'] . "px; ";
	$fc_style__fcc_css .=  "color: " . $fc_style__co_pric_font_color . "; ";
	$fc_style__fcc_css .=  "font-style: " . $fc_style__co_pric_font['font_style'] . "; ";
}
...
echo "</style><style>@import url('https://fonts.googleapis.com/css?family=" . $fc_style__co_pric_font['font-family'] . "');";
