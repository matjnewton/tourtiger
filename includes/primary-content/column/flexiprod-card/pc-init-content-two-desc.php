...
if ( get_sub_field( 'fc_style__ct_desc_font' ) ) {
	...
	if ( $fc_style__ct_desc_font['font-family'] ) {
		$fc_style__ct_desc_font_family = $fc_style__ct_desc_font['font-family'];
	} else {
		$fc_style__ct_desc_font_family = '"Roboto", Arial, sans-serif';
	}

	if ( $fc_style__ct_desc_font['font-weight'] ) {
		$fc_style__ct_desc_font_weight = $fc_style__ct_desc_font['font-weight'];
	} else {
...
echo "</style><style>@import url('https://fonts.googleapis.com/css?family=" . $fc_style__ct_desc_font['font-family'] . "');";
