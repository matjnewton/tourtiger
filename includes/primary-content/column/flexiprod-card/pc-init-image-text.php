...
/* Text Underline */
if ( get_sub_field( 'fc_style__imte_und' ) ) $fc_style__fcc_css .= 'text-decoration:underline;';

echo "</style><style>@import url('https://fonts.googleapis.com/css?family=" . $fc_style__imte_font['font-family'] . "');";
...
if ( get_sub_field( 'fc_style__imte_dec' ) == 'double' ) {
	echo '#pc_wrap .' . $fc_style . ' .fc_style--image_title:before {display: inline-block;position: absolute;left: 50%;left: 50%;width: 100%;border-top: 1px solid ' . $fc_style__imte_font_color . ';-webkit-transform: translateX(-50%);transform: translateX(-50%);top:0;}';
	echo '#pc_wrap .' . $fc_style . ' .fc_style--image_title:after {display: inline-block;position: absolute;left: 50%;left: 50%;width: 100%;border-top: 1px solid ' . $fc_style__imte_font_color . ';-webkit-transform: translateX(-50%);transform: translateX(-50%);bottom:0;}';
...
echo "</style><style>@import url('https://fonts.googleapis.com/css?family=" . $fc_style__imte_font_des['font-family'] . "');";
