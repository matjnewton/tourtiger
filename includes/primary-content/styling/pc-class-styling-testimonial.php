	...
	public static function get_styles( $style = '' ) {
		...
		if ( have_rows( $style, 'option' ) ) {
			while ( have_rows( $style, 'option' ) ) {
				...
				if ( $font ) {
					$css .= "body.{$style} .t-author .rate-about a.dz-testimonial__author, body.{$style} .t-author .rate-about span.dz-testimonial__author, body.{$style} .site-inner .archive-pagination li.active a {";
