	...
	function return_acf_group( $i = '', $c = '' ) {
		...
		$fc_options_array = array (
			...
			'sub_fields' => array(
				...
				array (
					'key' => $this->slug . $i . '_5836cbhead-line_h1',
					'label' => 'Headline h1',
					'name' => 'font-style_headline_h1',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836cbhead-line_h2',
					'label' => 'Headline h2',
					'name' => 'font-style_headline_h2',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836cbhead-line_h3',
					'label' => 'Headline h3',
					'name' => 'font-style_headline_h3',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836cbhead-line_h4',
					'label' => 'Headline h4',
					'name' => 'font-style_headline_h4',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836cbhead-line_h5',
					'label' => 'Headline h5',
					'name' => 'font-style_headline_h5',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836cbhead-line_h6',
					'label' => 'Headline h6',
					'name' => 'font-style_headline_h6',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836subhede_h1',
					'label' => 'Sub-headline H1',
					'name' => 'font-style_h-sub_h1',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836subhede_h2',
					'label' => 'Sub-headline H2',
					'name' => 'font-style_h-sub_h2',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836subhede_h3',
					'label' => 'Sub-headline H3',
					'name' => 'font-style_h-sub_h3',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836subhede_h4',
					'label' => 'Sub-headline H4',
					'name' => 'font-style_h-sub_h4',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836subhede_h5',
					'label' => 'Sub-headline H5',
					'name' => 'font-style_h-sub_h5',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5836subhede_h6',
					'label' => 'Sub-headline H6',
					'name' => 'font-style_h-sub_h6',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => 'pp_' . $i . '_prp_a__mhdeeeeele52',
					'label' => 'Expanable title',
					'name' => '__font-style',
					'type' => 'tab',
					'instructions' => '',
					'required' => '',
				...
				array (
					'key' => $this->slug . $i . '_5hexco432tle_e_h1',
					'label' => 'Expandable content H1',
					'name' => 'font-style_exco-title_h1',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5hexco432tle_e_h2',
					'label' => 'Expandable content H2',
					'name' => 'font-style_exco-title_h2',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5hexco432tle_e_h3',
					'label' => 'Expandable content H3',
					'name' => 'font-style_exco-title_h3',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5hexco432tle_e_h4',
					'label' => 'Expandable content H4',
					'name' => 'font-style_exco-title_h4',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5hexco432tle_e_h5',
					'label' => 'Expandable content H5',
					'name' => 'font-style_exco-title_h5',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => $this->slug . $i . '_5hexco432tle_e_h6',
					'label' => 'Expandable content H6',
					'name' => 'font-style_exco-title_h6',
					'type' => 'typography',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
	...
	public static function get_styles( $style = '' ) {
		...
		if ( have_rows( $style, 'option' ) ) {
			while ( have_rows( $style, 'option' ) ) {
				...
				for ( $i = 1; $i < 7; $i++ ) {
					$font_style_headline = get_sub_field( 'font-style_headline_h' . $i );
				...
				for ( $i = 1; $i < 7; $i++ ) {
					...
					$font_style_h_sub = get_sub_field( 'font-style_h-sub_h' . $i );
				...
				for ( $i = 1; $i < 7; $i++ ) {
					...
					$font_style_exco_title = get_sub_field( 'font-style_exco-title_h' . $i );
