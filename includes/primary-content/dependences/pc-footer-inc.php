...
(function(factory) {
    ...
    var pc_field_post_id = <?php echo $post->ID; ?>;
    var pc_field_offset = <?php echo $number; ?>;
    var pc_field_nonce = '<?php echo wp_create_nonce( 'pc_field_nonce' ); ?>';
    var pc_ajax_url = '<?php echo admin_url('admin-ajax.php'); ?>';
    var pc_more = true;
    ...
    var methods = {
        ...
        init: function () {
            ...
            $('.pc--r').find('.pc--crop__thumb').each(function(index, thisItem){
              ...
              $(this).animate( {'min-height': blog_thumb_h}, 500 );
            });
