...
return;
  ...
  j('.middle').show();
  dataValue=j( this ).serialize()+"&prod="+id_prods+"&label="+j('#all-classes').val()+"&action=10&oneway="+j('input[type=radio]:checked').val()+"&promo="+j('#promo-code').val()+"&from="+j('#all-places').val()+"&to="+j('#match-places').val()+"&pax="+j('#all-classes option:selected').text()+"&pp="+pp;
j.ajax({
      type: "POST",
