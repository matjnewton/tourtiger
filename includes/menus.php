...
class split_nav_walker extends Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        if( $this->break_point == $this->displayed )
            $output .= $indent . '</li></ul></div>'.$logo_item.'<div class="col-sm-5 col-md-5 col-lg-5 main-nav-wrapper"><ul class="menu genesis-nav-menu main-nav"><li' . $id . $value . $class_names .'>';
        else
